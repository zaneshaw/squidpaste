<template>
	<div class="flex flex-col gap-3">
		<h3>Privacy</h3>
		<p><b>Encrypted pastes conform to a zero-knowledge policy!</b></p>
		<p>
		...
		<p>A paste's language (plain-text, c, etc) and time of creation are <b>NOT</b> encrypted! Only the title and content/body are encrypted.</p>
	</div>
</template>
